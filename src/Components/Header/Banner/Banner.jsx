  ...
  return (
    <div>
      <div className="relative w-full h-[650px] ">
        ...
        <div className="relative ml-[19px] md:ml-[400px]">
          <div className="absolute mt-[220px]  md:mt-[200px]">
            <h1 className=" text-black text-2xl md:text-5xl font-bold mb-[10px] md:mb-[40px]">
              I Grow By Helping People In Need
            </h1>{" "}
            <br />
            <div className="text-center">
              <input
                className="w-[250px]  md:ml-5 md:w-[470px] h-[50px] bg-white rounded-l-lg border-solid border border-[#DEDEDE] pl-4 "
                type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4  md:gap-5 w-full md:w-[1400px] mx-auto mt-[30px] md:mt-[70px]">
